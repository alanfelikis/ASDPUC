...
grails.plugin.springsecurity.logout.afterLogoutUrl = '/logout/index'
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/areaRestrita/index'
...
grails.plugin.springsecurity.interceptUrlMap = [
	'/aluno/**':            ['ROLE_ADMIN', 'ROLE_FUNCIONARIO'],
	'/matricula/**':        ['ROLE_ADMIN', 'ROLE_FUNCIONARIO'],
	'/areaRestrita/**':     ['ROLE_ADMIN', 'ROLE_FUNCIONARIO'],
