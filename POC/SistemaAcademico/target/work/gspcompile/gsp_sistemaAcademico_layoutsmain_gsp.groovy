...
class gsp_sistemaAcademico_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(10)
invokeTag('message','g',27,['code':(InetAddress.getLocalHost().getHostAddress())],-1)
printHtmlPart(11)
...
public static final long LAST_MODIFIED = 1505575024559L
